---
title: "Monitoring Multi-Agent Code Generation with TraceRoot.AI"
...
pip install -r examples/multi_agent/requirements.txt
```
...
## 3. Multi-Agent Code Generation System Architecture
...
```bash
python3 examples/multi_agent/main.py
```
...
[`examples/multi_agent/main.py`](https://github.com/traceroot-ai/traceroot-examples/blob/ca1b657cb9276fe28de18bf9f40d89c757a771a7/examples/multi_agent/main.py#L183)
