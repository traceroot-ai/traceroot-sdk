...
def create_layout(response_fig, accuracy_fig, styles):
    ...
    return html.Div([
        html.H1("AI Agent Dashboard", style={
            'text-align': 'center', 
            'color': 'white', 
        ...
        html.Div([
            html.Div([
                ...
                dcc.Graph(figure=response_fig, style={'height': styles['chart_height']})
            ], style={
            ...
            html.Div([
                ...
                dcc.Graph(figure=accuracy_fig, style={'height': styles['chart_height']})
            ], style={
                'flex': f'0 0 {styles["card_width"]}',
                'background': 'rgba(255,255,255,0.95)',
                'border-radius': styles['border_radius'],
